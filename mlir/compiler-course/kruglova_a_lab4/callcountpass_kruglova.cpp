...
namespace {
class callcountpass_kruglova : public PassWrapper<callcountpass_kruglova, OperationPass<ModuleOp>> {
public:
    StringRef getArgument() const final { return "func-call-counter"; }
    StringRef getDescription() const final { return "Counts calls for func.func and adds call_count attribute"; }
